    ...
    def readData(self):
        ...
        if(dataArray[0]==10 and dataArray[lastIndex]==11):
            ...
            if (p == 40): # 60 seconds
                ...
                zData_smoothed1 = signal.savgol_filter(np.abs(zData_bandpass), window_length=15, polyorder=3) #magari rimettere polyorder 3
                self.window_length_MA = 15
                zData_smoothed1 = self.moving_average(self.window_length_MA, np.abs(zData_smoothed1))
