...
class SerialWorker(QRunnable):
    ...
    def readData(self):
        ...
        global zData_BP_FT, sum_data, flag_graph
        global FSR_index
...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        # Display 320 time points
        self.horAxis = list(range(320))  #320 time points
        self.xGraph = [0]*320
        self.yGraph = [0]*320
        self.zGraph = [0]*320
...
#
    ...
    def draw(self):
        """!
             @brief Draw the plots.
        """
        global accData, xData, yData, zData, xData_g, yData_g, zData_g, zData_lowpass, zData_bandpass, flag_graph
